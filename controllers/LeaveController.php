...
class LeaveController extends Controller
{
    ...
    public function actionPrint($id)
    {
        ...
        $pdf = new FPDF();
        $pdf->AddPage();
        $pdf->Image(Yii::getAlias('@projectLogoPath').'ppkk-official-logo.jpg', 20, 20, -500);
        $pdf->SetFont('Arial');
        $pdf->Cell(70);
        ...
        $pdf->Ln();
        $pdf->Cell(75);
        $pdf->Cell(40, 10, 'Telp. 021-4207688 (Hunting) Faks. 021-6543123', 1);
        ...
        $pdf->Cell(40, 10, 'Nama');
        $pdf->Cell(18);
        $pdf->Cell(40, 10, ': ' . $model->personnel->employee_name);
        $pdf->Ln();
        $pdf->Cell(15);
        $pdf->Cell(40, 10, 'NPP');
        $pdf->Cell(18);
        $pdf->Cell(40, 10, ': ' . $model->personnel->employee_code);
        $pdf->Ln();
        $pdf->Cell(15);
